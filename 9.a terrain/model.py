...
class Terrain:
    def __init__(self, app, position=(0, 0, 0), width=128, depth=128, max_height=75.0,
...
class Ground():
    def __init__(self, app, position=(0, 0, 0), texture: str = 'dirt',
        ...
        self.shader_program = app.shader.get_shader(shader_name)
...
class Grass:
    def __init__(self, app, position=(0, 0, 0), texture: str = 'grass',
        ...
        self.tex_id = app.texture.get_alpha_texture(path=f'{app.texture_path}/{texture}.png')
        self.tex_id_wind = app.texture.get_basic_texture(path=f'{app.texture_path}/flow_map.png')
    ...
    def render_shadow(self):
        ...
        # self.shadow_program['m_view_light'].write(self.app.global_light.m_view_light)
        # self.shadow_program['m_model'].write(self.position)
        # self.shadow_vao.render(moderngl.POINTS)
        return
    ...
    def get_shadow_vao(self):
        vao = self.ctx.vertex_array(self.shadow_program, [(self.vbo, '3f', 'in_position')])
        return vao
